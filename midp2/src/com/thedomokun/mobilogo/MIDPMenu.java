...
import com.thedomokun.gui.MIDPFont;
 ...
 * 
 */
public class MIDPMenu extends Menu {
    private MIDPFont menuFont;
    ...
    */
    ...
    public MIDPMenu(String l, MIDPMenu [] m) {
        super();
        label = l;
        subMenu = m;
    }
    ...
    public void init_fonts() {
        menuFont = (MIDPFont)MIDPFont.getFont(Font.FACE_PROPORTIONAL,
                                              Font.STYLE_PLAIN,
                                              Font.SIZE_MEDIUM);
        boldMenuFont = (MIDPFont)MIDPFont.getFont(Font.FACE_PROPORTIONAL,
                                              Font.STYLE_BOLD,
                                              Font.SIZE_MEDIUM);
        smallMenuFont = (MIDPFont)MIDPFont.getFont(Font.FACE_PROPORTIONAL,
                                                   Font.STYLE_PLAIN,
                                                   Font.SIZE_SMALL);
        smallBoldMenuFont = (MIDPFont)MIDPFont.getFont(Font.FACE_PROPORTIONAL,
                                                       Font.STYLE_BOLD,
                                                       Font.SIZE_SMALL);        
    }

    public MIDPMenu(int c) {
        super();
    ...
    private void setNumberFont(Graphics g) {
        numberFont = MIDPFont.getFont(Font.FACE_PROPORTIONAL,
    ...
    private void drawMenuItem(Graphics g, MIDPMenu menu, int x, int y, int anchor)
    {
    ...
    public void drawMenu(Graphics g) {
        ...
        // Draw menu items
        g.setColor(0);
        MIDPMenu [] subMenu = (MIDPMenu[])menuStack[menuStackPtr].subMenu;
        if (subMenu.length >= 1)
